...
📊 데이터 분석 능력, 백서버 및 클라이언트 개발을 통해 웹 구현 공부를 하고 있습니다.

💻 Python 기반으로 공부를 시작했고, 프론트엔드를 위해 JS 및 JSX를 공부하고 있습니다. 또한 서버 개발을 위해 JAVA 기반 Spring을 공부하고 있습니다.
